...
#     command = "scp -i /home/ubuntu/projetC/infra-drupal/key.pem /home/ubuntu/projetC/infra-drupal/copyfile.tf ubuntu@${aws_instance.ec2-drupal.public_ip}:/home/ubuntu/"
#   }
# }
